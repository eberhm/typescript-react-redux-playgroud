...
namespace React {
    ...
    interface CSSProperties {
        ...
        /**
         * Gets or sets a value that indicates which row an element within a Row should appear in. Shorthand for setting grid-row-start and grid-row-end in a single declaration.
         */
        gridRow?: any;
